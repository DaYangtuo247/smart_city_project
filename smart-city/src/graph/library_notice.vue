...
export default defineComponent({
    ...
    setup() {
        const list = ref([
            ...
            {
                title: "我馆在第二届湖北省属高校图书馆阅读推广工作研讨会上交流分享",
                date: "6-20",
            },
            {
                title: "我馆组织馆员参加湖北省高校图书馆“青春筑梦 强国有我”思政主题知识竞赛活动获表彰",
                date: "6-20",
            },
            {
                title: "“浓情迎端午 巧手做香囊”——图书馆分工会开展端午节活动",
                date: "6-16",
            },
            {
                title: "湖北省高校图书馆 “云上雅游|数字奇遇·探‘悦’之旅” 世界读书日活动",
                date: "6-16",
            },
            {

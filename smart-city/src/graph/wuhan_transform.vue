<template>
    ...
    <div ref="transRef" style="width: 388px; height: 280px"></div>
</template>
...
export default {
    ...
    methods: {
        // 初始化图表的方法
        initChart() {
            let myChat = this.chartInstance;
            // my_chat = this.$echarts.init(this.$refs.moveRef, "default");
            myChat = this.$echarts.init(this.$refs.transRef, "default");
            const pathSymbols = {
            reindeer:
            ...
            myChat.setOption(options[optionIndex]);
            }, 2500);
